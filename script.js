  ...
  const tableData = [
    {
      ...
      items: [
        ...
        { desc: 'Cafeína + Beta Alanina Xtra 60caps', unit: 21.10, tag: '' },
        { desc: 'Cálcio MDK + Z 60caps (Cálcio, Magnésio, Vit.D, Vit.K, Zinco)', unit: 20.93, tag: '' },
        { desc: 'Carbonato de Cálcio 60 Caps', unit: 16.14, tag: '' },
        { desc: 'Coenzima Q10 200mg com vitamina E 30caps', unit: 36.79, tag: '' },
        { desc: 'Creatina Xtra 300G', unit: 51.02, tag: 'novo' },
        { desc: 'Creatina Gummies - Uva verde 40gomas', unit: 74.79, tag: '' },
        { desc: 'Colágeno Tipo 2 30cap', unit: 19.79, tag: '' },
        { desc: 'Colágeno Premium 200G Frutas vermelhas', unit: 44.34, tag: 'novo' },
        { desc: 'CurcuMAX 95% - Cúrcuma com Pimenta Preta 60 caps - ÂMBAR', unit: 15.12, tag: '' },
        { desc: 'Curcumina com colágeno tipo 2 30ml - Gotas', unit: 20.90, tag: 'gotas' },
        { desc: 'Cúrcuma Longa com Curcumina 60caps', unit: 23.08, tag: '' },
        { desc: 'CO-MAG 60caps', unit: 34.33, tag: '' },
        { desc: 'D3 + K2 30caps - 2000UI / 159mcg', unit: 11.71, tag: '' },
        { desc: 'D3 + K2 GOTAS 20ML', unit: 18.16, tag: 'novo' },
        { desc: 'Ferrofor + C 60caps', unit: 16.77, tag: '' },
        { desc: 'Feno Grego 60caps', unit: 20.45, tag: '' },
        { desc: 'GABA 400 60caps', unit: 17.58, tag: '' },
        { desc: 'Morofor 120caps', unit: 33.74, tag: '' },
        { desc: 'Melatonina com Triptofano 30caps', unit: 18.89, tag: '' },
        { desc: 'Magnésio Dimalato 60caps', unit: 20.36, tag: '' },
        { desc: 'Magnésio Inositol DIA (Taurina) 210g - Maracujá', unit: 53.94, tag: '' },
        { desc: 'Magnésio Inositol NOITE (Melatonina) 210g - Maracujá', unit: 53.94, tag: '' },
        { desc: 'Magnésio L-Treonato 60caps', unit: 16.18, tag: '' },
        { desc: 'Magnésio L-Treonato 60caps - ÂMBAR', unit: 16.03, tag: '' },
        ...
        { desc: 'Melatokalm Gotas Sabor Maracujá 30ml (Melatonina)', unit: 19.11, tag: 'gotas' },
        { desc: 'Mag 6 60caps (seis magnésios)', unit: 21.85, tag: '' },
        { desc: 'NAC - 800 60caps', unit: 23.11, tag: 'novo' },
        { desc: 'Óleo de Primula 60caps Softgel', unit: 27.21, tag: '' },
        { desc: 'Óleo de Semente de Abóbora 1000mg 60cap', unit: 31.63, tag: '' },
        { desc: 'Ômega 3 60caps 1gr Softgel', unit: 25.87, tag: '' },
        { desc: 'Ômega 3, 6, 9 60caps 1gr Softgel', unit: 29.86, tag: '' },
        { desc: 'PEA-600 60caps', unit: 33.58, tag: '' },
        { desc: 'PEA + Colágeno Tipo 2 60caps', unit: 36.26, tag: '' },
        { desc: 'Picolinato de Cromo 30caps', unit: 13.75, tag: '' },
        { desc: 'PlenaMente 30caps', unit: 18.37, tag: '' },
        { desc: 'Própolis Verde 60caps', unit: 19.70, tag: '' },
        ...
        { desc: 'SuperVita C 60caps', unit: 19.40, tag: '' }
      ]
    },
    {
      brand: '',
      ...
      items: [
        ...
        { desc: 'Ashwagandha 60caps', unit: 22.63, tag: '' },
        ...
        { desc: 'Óleo de Sucupira 1000mg 60cap', unit: 24.09, tag: '' },
