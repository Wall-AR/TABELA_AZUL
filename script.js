  ...
  const tableData = [
    {
      ...
      items: [
        ...
        { desc: 'Creatina Monohidratada 150g Natural', unit: 49.88, tag: '' },
        ...
        { desc: 'Derma B -Biotina Gummy 30gomas-Morango', unit: 40.75, tag: 'ultimo-lote' },
        ...
        { desc: 'Óleo de Primula 60caps Softgel', unit: 23.55, tag: '' },
        { desc: 'Óleo de Semente de Abóbora 1000mg 60cap', unit: 34.32, tag: 'novo' },
        { desc: 'Ômega 3 IFOS 60caps 1gr Softgel', unit: 42.50, tag: '' },
        { desc: 'Ômega 3, 6, 9 60caps 1gr Softgel', unit: 35.60, tag: '' },
    ...
    },
    {
      ...
      items: [
        ...
        { desc: 'Colágeno Tipo 2 60cap', unit: 20.86, tag: '' },
        ...
        { desc: 'Óleo de Abacate 1000mg 60cap', unit: 29.83, tag: 'ultimo-lote' },
        { desc: 'Óleo de Alho 500mg 60cap', unit: 21.51, tag: '' },
        { desc: 'Óleo de Semente de Abóbora 1000mg 60cap', unit: 34.32, tag: 'ultimo-lote' },
